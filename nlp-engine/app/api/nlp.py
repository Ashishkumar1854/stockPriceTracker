...
from app.services.predictor import predict_price_move
...
async def analyze_news(req: AnalyzeRequest):
    ...
    for art in req.articles:
        ...
        compounds.append(sentiment["scores"]["compound"])

    avg_compound = sum(compounds) / len(compounds) if compounds else 0.0
    predicted_move = predict_price_move(avg_compound)
...
async def scrape_and_analyze(
    ...
    from app.models import Article, AnalyzeRequest
